...
public class VenueSeeder {
    ...
    public void seed() {
        ...
        List<VenueSeedDto> dtos = List.of(
                // CMSS
                VenueSeedDto.builder().name("CMSS E101").capacity(192).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS A201").capacity(76).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS E201").capacity(69).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS G201").capacity(144).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS G301").capacity(100).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS B301").capacity(144).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS C301").capacity(488).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS E301").capacity(92).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS H301").capacity(132).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS E401A").capacity(36).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS E401B").capacity(0).collegeCode("CMSS").available(false).build(), // unavailable
                VenueSeedDto.builder().name("CMSS F301").capacity(92).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS F401").capacity(60).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS C401").capacity(128).collegeCode("CMSS").build(),
                VenueSeedDto.builder().name("CMSS H401").capacity(448).collegeCode("CMSS").build(),
                ...
                VenueSeedDto.builder().name("CST Seminar Room (500L Only)").capacity(80).collegeCode("CST").build(),
