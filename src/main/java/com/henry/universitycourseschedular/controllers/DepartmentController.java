...
public class DepartmentController {
    ...
    @PostMapping
    public ResponseEntity<DefaultApiResponse<Department>> create(@Valid @RequestBody DepartmentDto dto) {
        return ResponseEntity.ok(departmentService.createDepartment(dto));
    }

    @PutMapping("/{id}")
    public ResponseEntity<DefaultApiResponse<Department>> update(@PathVariable Long id,
    ...
    @GetMapping
    public ResponseEntity<DefaultApiResponse<List<Department>>> getAll() {
        return ResponseEntity.ok(departmentService.getAllDepartments());
    }

    @GetMapping("/{id}")
    public ResponseEntity<DefaultApiResponse<Department>> getById(@PathVariable Long id) {
